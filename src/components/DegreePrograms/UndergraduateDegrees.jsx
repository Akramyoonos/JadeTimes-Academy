    ...
    <div className="bg-gradient-to-br from-gray-50 to-gray-100 font-sans animated-gradient">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex items-center px-6 sm:px-6 md:px-6 lg:px-27 mb-12">
          <span className="w-1.25 h-12 bg-blue-400 mr-4"></span>
          <h1 className="text-3xl lg:text-5xl font-bold tracking-wider uppercase text-black" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.1)' }}>
