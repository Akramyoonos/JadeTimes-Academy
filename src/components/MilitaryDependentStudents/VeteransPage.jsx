      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
        ...
        <div className="lg:col-span-3">
          ...
          <h1 className="pl-4 mb-6 text-2xl font-semibold leading-snug border-l-4 border-yellow-400 sm:text-3xl md:text-4xl">
            VETERANS & MILITARY DEPENDENT <br /> EDUCATION BENEFITS AT JIU
          </h1>

          {/* Paragraphs */}
          <div className="space-y-6 leading-relaxed text-gray-700">
            <p>
              The New York Film Academy (JIU) has been privileged to enroll
              ...
              and on-air military strategist for NBC/MSNBC, is the Chair of the JIU
              Veterans Advancement Program. Retired Command Sergeant Major Chris Moore
              is the Director of Veterans Services.
            </p>

            <p>
              JIU’s Division of Veterans Services (DVS) has been able to bring
              ...
              JIU’s DVS also engages with U.S. military installations around the
            ...
            <p>
              ...
              Angeles Campus. JIU’s media content team and an all-veteran student
              crew filmed the event, which provided the vet students studying
              Filmmaking, Documentary, and Producing at JIU with the valuable
            ...
            <p>
              JIU’s DVS collaborates with Hire Heroes USA (HHUSA) to host daylong
              exclusive employment workshops for JIU’s veteran students that provide
              ...
              based at JIU’s NYC Campus — the opportunities have included visits to
            ...
            <div>
              <p>Additional information about JIU’s Veterans Services on these pages:</p>
        ...
        {/* Right Sidebar */}
          ...
          <div className="pt-6 mt-8 border-t border-gray-200">
            ...
            <p className="text-base text-gray-700">
              JIU is proud to have a Veteran Services office fully staffed by veterans
