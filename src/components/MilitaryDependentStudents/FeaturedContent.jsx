  ...
  return (
    <div className="bg-gray-50 font-sans text-gray-900 py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={scrollContainer} className="flex space-x-8 overflow-hidden pb-8" role="list">
          <article className="relative flex-shrink-0 w-full md:w-3/4 lg:w-2/3 xl:w-2/2 h-[500px] sm:h-[450px] md:h-[500px]  overflow-hidden shadow-xl group" role="listitem">
            <img
