...
const ApplyJIU = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://process.jadetimesuniversity.com/index.php", { // Replace with your PHP script URL
        method: "POST",
        headers: {
      ...
      <div className="max-w-7xl  flex flex-col md:flex-row gap-8 md:gap-12 items-start justify-center">
        <div className="w-full md:w-1/2">
          <h1 className="text-3xl md:text-4xl font-semibold flex items-center gap-3">
            ...
            APPLY TO JADEJA TIMES UNIVERSITY
          </h1>
          ...
          <>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <input
                      ...
                      id="firstName"
                      required
                      className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-pink-500 focus:border-pink-500 sm:text-sm h-10 px-3"
                ...
                <div className="pt-4">
                  <button
                    type="submit"
                    className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-lg font-medium text-white bg-pink-600 hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
