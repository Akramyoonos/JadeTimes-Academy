  ...
  return (
    <div className="w-full px-4 md:px-12 lg:px-34 py-10">
      ...
      <p className="text-gray-600 text-2xl">
        Have a question? Call us at <span className=" text-2xl font-semibold">1-800-611-FILM</span> or email{" "}
        <a href="mailto:admissions@JIU.edu" className="text-purple-600 text-2xl ">admissions@JIU.edu</a>
      </p>
    </div>
  );
};
