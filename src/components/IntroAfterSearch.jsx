...
export default function IntroAfterSearch() {
  return (
    <section className="bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-26">
        <h2 className="text-sm sm:text-3xl font-stretch-50%- text-gray-900 mb-6">
          Hands-on Film, Media, and Performing Arts School
        </h2>
        <p className="text-lg font-stretch-50% text-gray-700 leading-7">
