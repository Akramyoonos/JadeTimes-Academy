...
const City3 = () => {
  ...
  return (
    <div className="bg-white font-sans">
      <div className="container mx-auto py-12 px-6 sm:px-6 md:px-6 lg:px-35 relative">
        ...
        <div>
          ...
          <button onClick={toggleReadMore} className="text-purple-600 font-semibold text-sm flex items-center group">
            ...
            <FontAwesomeIcon icon={faChevronDown} className={`h-4 w-4 ml-1 transform transition-transform ${isExpanded ? 'rotate-180' : ''}`} />
          </button>
        </div>
