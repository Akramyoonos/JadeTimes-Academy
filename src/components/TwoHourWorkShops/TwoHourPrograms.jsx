      ...
      <header className="relative mb-10 md:mb-16">
        <div className="grid grid-cols-1 lg:grid-cols-1 gap-1">
          <div className='px-6 sm:px-6 md:px-6 lg:px-33'>
            <h1 className="text-4xl lg:text-4xl font-semibold tracking-wide uppercase ext-black flex items-start">
              <span className="block w-1.25 h-14 bg-yellow-400 mr-6 UPP flex-shrink-0"></span>
...
export default TwoHourPrograms;