...
const Heading = () => {
  return (
    <div className="relative w-full h-[250px] sm:h-[350px] md:h-[350px] lg:h-[400px] xl:h-[450px] overflow-hidden">
      <img
      ...
      <nav className="absolute z-20 flex items-center  pr-1 py-2 space-x-3 font-sans text-sm text-white uppercase rounded-full top-8 left-4 sm:text-base bg-opacity-30">
              ...
              <span className="text-gray-300">/</span>
              <span>JIU ADMINISTRATION</span>
            </nav>

      <h1 className="absolute z-20 font-sans text-lg font-semibold tracking-wide text-white uppercase -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 sm:text-3xl md:text-4xl lg:text-5xl text-shadow-lg">
       jiu ADMINISTRATION
      </h1>
    </div>
  );
