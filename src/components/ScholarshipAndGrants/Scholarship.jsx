      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex flex-col lg:flex-row">
          <div className="w-full lg:w-3/4 lg:pr-8">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-light text-gray-700 mb-4">JIU Institutional Scholarships</h2>
          ...
          <div className="w-full lg:w-1/4 mt-8 lg:mt-0">
            ...
            <div className="bg-gray-100 p-6">
              ...
              <ul>
                <li className="border-t border-gray-200 py-2"><a href="#" className="text-gray-600 hover:text-purple-500">JIU STUDENT FINANCES</a></li>
