...
const Heading = () => {
  return (
    <div className="relative w-full h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] xl:h-[500px] overflow-hidden">
                 ...
                 <nav className="absolute z-20 flex items-center px-12 py-2 space-x-3 font-sans text-sm text-white uppercase rounded-full top-8 left-2 sm:text-base bg-opacity-30">
