...
const studentsData = [
  {
    ...
    quote: 'Since enrolling in JadeTimes’s BFA Acting for Film degree, my classes, peers and professors have opened up a new world for me that I have come to appreciate and am proud to be a part. I cannot wait to use all the techniques and tools I’ve learned to continue my journey into the film industry.',
