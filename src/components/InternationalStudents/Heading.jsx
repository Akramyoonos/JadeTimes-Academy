...
const Heading = () => {
  return (
    <div className="relative w-full h-[200px] sm:h-[250px] md:h-[300px] lg:h-[350px] xl:h-[400px] overflow-hidden">
      ...
      <nav className="absolute z-20 flex items-center px-1 py-2 space-x-3 font-sans text-sm text-white uppercase rounded-full top-8 left-8 sm:text-base bg-opacity-30">
      ...
      <h1 className="absolute z-20 font-sans text-2xl text-white uppercase -translate-x-1/2 -translate-y-1/2 sm:text-2xl md:text-3xl lg:text-4xl font-semiboldtracking-wide top-1/2 left-1/2 text-shadow-lg">
