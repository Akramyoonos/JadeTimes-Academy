  ...
  return (
    <div className="relative w-full h-[200px] sm:h-[250px] md:h-[500px] lg:h-[600px] xl:h-[700px] overflow-hidden">
             <div 
               ...
               style={{ background: 'linear-gradient(0deg, #ff0000 0%, #1f33c7 100%)' }}
             ></div>
             <div className="absolute inset-0 z-10 bg-black opacity-50"></div>
              <nav className="absolute top-4 left-4 sm:top-8 sm:left-8 z-20 flex flex-wrap items-center space-x-2 uppercase text-white text-xs sm:text-sm font-sans bg-opacity-30 px-3 sm:px-4 py-2 rounded-full">
                   ...
                   <span className="text-gray-300">/</span>
                   <a href="/" className="nohover:underline">JIU Partnerships</a>
                 </nav>
             <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-4 text-center text-white">
                <h1 className="font-sans text-2xl tracking-wide uppercase sm:text-3xl md:text-4xl lg:text-5xl font-semiboldmax-w-5xl text-shadow-lg">
                   JIU Partnerships
                </h1>
             </div>
           </div>
