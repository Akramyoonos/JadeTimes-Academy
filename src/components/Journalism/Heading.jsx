...
import AboutHeading from "../../assets/Images/JournalismImg.webp";
...
const Heading = () => {
  return (
    <div className="relative w-full h-[300px] sm:h-[250px] md:h-[300px] lg:h-[350px] xl:h-[400px] overflow-hidden">
      ...
      <h1 className="absolute z-20 font-sans text-2xl font-semibold tracking-wide text-white uppercase -translate-x-1/2 -translate-y-1/2 sm:text-3xl md:text-4xl lg:text-5xl top-1/2 left-1/2 text-shadow-lg">
        JOURNALISM
      </h1>
    </div>
  );
