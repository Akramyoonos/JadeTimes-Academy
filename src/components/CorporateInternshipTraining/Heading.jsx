  ...
  return (
    <div className="relative w-full h-[200px] sm:h-[250px] md:h-[300px] lg:h-[350px] xl:h-[400px] overflow-hidden">
      ...
      <nav className="absolute top-4 left-4 sm:top-8 sm:left-8 z-20 flex flex-wrap items-center space-x-2 uppercase text-white text-xs sm:text-sm font-sans bg-opacity-30 px-3 sm:px-4 py-2 rounded-full">
              ...
              <Link to="/discover"><span className="font-semibold hover:underline">CERTIFICATE PROGRAMS</span></Link>
              <span className="text-gray-300">/</span>
              <span>CORPORATE INTERNSHIP TRAINING</span>
            </nav>
      <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 uppercase text-white text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-sans font-semibold tracking-wide text-shadow-lg">
       CORPORATE INTERNSHIP TRAINING
      </h1>
    </div>
  );
};
