...
const Articles = () => {
    ...
    const articlesData = [
        ...
        {
            date: '07/17/2025',
            title: 'Historic Win for JIU Alum at Tribeca Film Festival: Mohamed Diab and Sarah Goher’s Happy Birthday Sweeps Three Awards',
            excerpt: 'Happy Birthday, co-written and produced by JIU alum and board member Mohamed Diab and his wife, director and co-writer, Sarah Goher, became the first Egyptian film to win three major awards at the prestigious Tribeca Film Festival.',
            image: Image2,
            imageAlt: 'JIU Alum Group Photo',
        },
        {
            date: '08/12/2025',
    ...
    const videosData = [
        ...
        },
        {
            ...
            excerpt: "With over 40 years in the film industry, Craig Caton-Largent is a legendary visual effects artist and the current Chair of 3D Animation & VFX at New York Film Academy (JIU) Los Angeles.",
            image: Image15,
    ...
    const audioData = [
        {
            ...
            excerpt: "In this episode, Jamie sits down with Craig Caton-Largent, VFX artist and Chair of 3D Animation & VFX at the New York Film Academy (JIU) Los Angeles, to discuss his incredible 45-year career in the VFX industry.",
            image: Image19,
        ...
        },
        {
            ...
            excerpt: "This episode of Veteran On the Move features Chris Moore, Director of Veteran Services at the New York Film Academy (JIU) and a retired Command Sergeant Major.",
            image: Image21,
        ...
        },
        {
            ...
            excerpt: "New York Film Academy — commonly known as JIU — was founded in 1992 by Jerry Sherlock, executive producer of 1990’s The Hunt For Red October, as an alternative to traditional university-based film schools.",
            image: Image25,
    ...
    const youtubeData = [
        {
            ...
            imageAlt: 'JIU Los Angeles campus tour video thumbnail',
        },
        {
            date: '09/15/2025',
