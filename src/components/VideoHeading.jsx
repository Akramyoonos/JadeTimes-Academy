...
const VideoHeading = ({ title, subtitle }) => {
  return (
    <div className="font-sans relative">
      ...
      <div className="relative w-full h-60 sm:h-96 md:h-[500px] lg:h-[290px] overflow-hidden">
        <video
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-4 z-10">
          ...
          <div className="mt-6 max-w-3xl mx-auto">
            <p className="text-base sm:text-xl md:text-2xl font-bold tracking-wider text-gray-200">
              {subtitle}
            </p>
          </div>
        </div>
