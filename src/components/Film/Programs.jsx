            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="relative group">
                        <img src="https://images.unsplash.com/photo-1578652939228-26f54b2b0a9d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Man operating a camera with dramatic lighting" className="w-full h-auto object-cover" />
                    ...
                    <div className="relative group">
                        <img src="https://images.unsplash.com/photo-1604900984852-251f28746c10?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Filming a scene with a professional camera and colorful smoke" className="w-full h-auto object-cover" />
                        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-end p-8">
