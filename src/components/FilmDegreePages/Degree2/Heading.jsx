...
import AboutHeading from "../../../assets/Images/HistoryofCinemaImg.webp";
  ...
  return (
    <div className="relative w-full h-[200px] sm:h-[250px] md:h-[300px] lg:h-[400px] xl:h-[500px] overflow-hidden">
      ...
      <nav className="absolute top-4 left-4 sm:top-8 sm:left-8 z-20 flex flex-wrap items-center space-x-2 uppercase text-white text-xs sm:text-sm font-sans bg-opacity-30 px-3 sm:px-4 py-2 rounded-full">
        ...
        <span className="text-gray-300">/</span>
        <span> History of Cinema</span>
      </nav>
      <h1 className="absolute z-20 font-sans text-2xl tracking-wide text-white uppercase -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 sm:text-3xl md:text-4xl lg:text-5xl font-semiboldtext-shadow-lg whitespace-nowrap">
       History of Cinema
       </h1>
