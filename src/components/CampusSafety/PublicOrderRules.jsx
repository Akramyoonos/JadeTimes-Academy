...
<div className="max-w-7xl ml-12  py-8">
      ...
      <div className="ml-8 mb-4">
        ...
        <p className="text-gray-700">
          <span className="text-blue-500 font-bold">06.</span> Recklessly or intentionally endangering mental or physical health or forcing consumption of liquor or drugs for the purpose of initiation into or affiliation with any organization.
        </p>
      </div>
      ...
      <p className="text-gray-700 mt-4 mb-8">
        <span className="text-blue-500 font-bold">E.</span> Nothing contained in these rules is intended, nor shall it be construed, to limit or restrict the freedom of speech or peaceful assembly.
      </p>
      ...
      <p className="text-gray-700 mt-4">
        <span className="text-blue-500 font-bold">A.</span> Visitors (Invitees, Licensees, and Trespassers)
      </p>
      ...
      <div className="ml-8 mb-4">
        <p className="text-gray-700">
          <span className="text-blue-500 font-bold">01.</span> Warning
        </p>
        <p className="text-gray-700">
          <span className="text-blue-500 font-bold">02.</span> Disciplinary Probation
        </p>
        <p className="text-gray-700">
          <span className="text-blue-500 font-bold">03.</span> Removal of privileges
        </p>
        <p className="text-gray-700">
          <span className="text-blue-500 font-bold">04.</span> Deferred Suspension or Suspension
        </p>
        <p className="text-gray-700">
          <span className="text-blue-500 font-bold">05.</span> Dismissal or Expulsion
        </p>
      </div>
    </div>
  );
...
export default PublicOrderRules;
