...
<div className="bg-gray-100 font-sans py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
         ...
         <div className="relative p-8 rounded-lg shadow-2xl min-h-[500px] flex flex-col justify-between text-white transform hover:scale-105 transition-transform duration-300" style={{ background: 'linear-gradient(0deg, #ff00bb 0%, #0c1ea1 100%)' }}>
            <div>
              <h2 className="text-2xl font-bold uppercase tracking-widest">Academic Programs</h2>
              <p className="mt-4 text-indigo-200">Explore our collaborations with industry leaders and institutions.</p>
            </div>
            <div className="flex justify-end items-center">
              <a href="/Academic-Programs/" className="w-12 h-12 border-2 border-white rounded-full flex items-center justify-center cursor-pointer hover:bg-white hover:text-indigo-700 transition-colors duration-300">
