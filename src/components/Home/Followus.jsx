...
const FollowUs = () => {
  ...
  return (
    <div className="mx-auto px-4 mt-12 sm:px-6 lg:px-12 pb-12">
      {/* Header Section */}
        ...
        {images.map((image, index) => (
          ...
          >
            ...
            <img
              src={image.src}
              alt={image.alt}
              className="w-full h-full object-cover block transition-transform duration-2000 ease-in-out group-hover:scale-115"
            />
