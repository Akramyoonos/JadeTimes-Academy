...
const megaMenus = {
  academicsMenu: {
    "AREAS OF STUDY": [
      { text: "FILM", href: "/film/" },
      { text: "MEDIA ARTS", href: "/Media-Arts/", noHover: true },
      { text: "PERFORMING ARTS", href: "/Performing-Arts/", noHover: true },
      { text: "CREATIVE EXPRESSION", href: "/Creatie-Expression/", noHover: true },
      { text: "JOURNALISM", href: "/Journalism/", noHover: true },
      { text: "COMMUNIVATION", href: "/Comunivation/", noHover: true },
      { text: "DIGITAL MEDIA", href: "/Digital-Media/", noHover: true },
      { text: "TECHNOLOGY", href: "/Technology/", noHover: true },
      { text: "INTERACTIVE MEDIA", href: "/Intrractive-Media/", noHover: true },
      { text: "ENTERTAINMENT MEDIA", href: "/Entertainment-Media/", noHover: true },
      { text: "PSYCHOLOGY", href: "/Psychology/", noHover: true },
      { text: "HUMAN BEHAVIOR", href: "/Human-Behavior/", noHover: true },
  ...
  admissionsFinancesMenu: {
    "ADMISSIONS": [
      ...
      { text: "APPLICATION DEADLINES", href: "/Application-Deadlines/" },
      { text: "ADMISSIONS REQUIREMENTS", href: "/admissions-requirements/" },
      { text: "INTERNATIONAL STUDENTS", href: "/international-students/" },
      { text: "MILITARY DEPENDENT STUDENTS", href: "/military-dependent-students/" },
      { text: "MEET JIU NEAR YOU", href: "/events/list/" },
    ],
    "FINANCES": [
      { text: "TUITION", href: "/Areas-Of-Study/" },
      { text: "SCHOLARSHIPS & GRANTS", href: "/scholarships-and-grants/" },
  ...
  discoverMenu: {
    "WHO WE ARE": [
      ...
      { text: "HISTORY", href: "/The-History-Of-JIU/" },
      ...
      { text: "LEADERSHIP & ADMINISTRATION", href: "/leadership-At-JIU/" },
      { text: "JIU REVIEWS", href: "/reviews/page/" },
      { text: "FAQ", href: "/faq/" },
      { text: "JIU CATALOGS", href: "/JIU-Course-Catalogs/" },
    ...
    "ON CAMPUS": [
      ...
      { text: "CAMPUS SAFETY & CLERY ACT", href: "/campus-safety/" },
